...
class SingleInvoices extends Component
{
    ...
    public function print($id)
    {
        ...
        return Redirect::route('Print_single_invoices', [
            ...
            'Service_id' => $single_invoice->Service->nameLang,
    ...
    public function edit($id)
    {
        ...
        $this->section_id = DB::table('sections')->where('id', $single_invoice->section_id)->first()->name_en;
        ...
        if ($this->type == 1) {
            try {
                ...
                if ($this->updateMode) {
                    ...
                    $single_invoices->section_id = 3;
                    // $single_invoices->section_id = DB::table('sections')->where('name_en', $this->section_id)->first()->section_id;
