    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('Service.index') }}">{{ trans('Dashboard/Service.Single_Serve') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ route('Add_GroupServices') }}">{{ trans('Dashboard/Service.Group_Services') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ route('insurance.index') }}">{{ trans('Dashboard/Service.Insurance_Companies') }}</a>
                    </li>
                    <li><a class="slide-item"
                            href="{{ route('Ambulance.index') }}">{{ trans('Dashboard/Service.Ambulance') }}</a>
                    </li>
                    <li><a class="slide-item" href="#">{{ trans('Dashboard/Service.Ambulance_Calls') }}</a>
                    </li>
                </ul>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{ trans('Dashboard/Service.patients') }}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
                            href="{{ route('Patients.index') }}">{{ trans('Dashboard/patient.Add_patient') }}</a>
                    </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{ trans('Dashboard/Service.Invoices') }}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <circle cx="14.5" cy="7.5" r="1.5" />
                        <circle cx="17.5" cy="11.5" r="1.5" />
                    </svg><span class="side-menu__label">{{ trans('Dashboard/accounts.Accounts') }}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item"
