    ...
    <div class="main-sidemenu">
        ...
        <div class="app-sidebar__user clearfix">
            <div class="dropdown user-pro-body">
                ...
                <div class="user-info">
                    <h4 class="font-weight-semibold mt-3 mb-0">{{ Auth::user()->namelang }}</h4>
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">{{ trans('doctor/doctor.Statements') }}</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li>
                        <a class="slide-item" href="{{ route('invoices.index') }}">
                            {{ trans('doctor/doctor.List_Statements') }}</a>
                    </li>
                    <li>
                        <a class="slide-item" href="{{ route('completedInvoices') }}">
                            {{ trans('doctor/Invoices.Completed_statements') }}</a>
                    </li>
                    <li>
                        <a class="slide-item" href="{{ route('reviewInvoices') }}">
                            {{ trans('doctor/Invoices.review') }}</a>
                    </li>
                </ul>
            </li>
