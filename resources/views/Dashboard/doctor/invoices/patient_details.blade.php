...
@section('title')
    {{ trans('doctor/Invoices.patient_information') }}
@endsection
                                                ...
                                                <table class="table table-hover text-md-nowrap text-center">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th> {{ trans('doctor/Invoices.doctors_name') }}</th>
                                                            {{-- <th>اسم موظف الاشعة</th> --}}
                                                            <th> {{ trans('doctor/Invoices.Detection_status') }}</th>
                                                    ...
                                                    <tbody>
                                                        @foreach ($patient_rays as $patient_ray)
                                                            <tr>
                                                                ...
                                                                <td>{{ $patient_ray->descriptionlang }}</td>
                                                                <td>{{ $patient_ray->doctor->namelang }}</td>
