...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ trans('Dashboard/ambulance.Services') }}</h4>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('Dashboard/ambulance.ambulance') }}
                </span>
            </div>
        </div>
    </div>
                    ...
                    <form action="{{ route('Ambulance.store') }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" name="car_model_en" value="{{ old('car_model_en') }}"
                                    class="form-control @error('car_model') is-invalid @enderror">
                            </div>

                            <div class="col">
                                <label>{{ trans('Dashboard/ambulance.car_model_ar') }}</label>
                                <input type="text" name="car_model_ar" value="{{ old('car_model_ar') }}"
                                    class="form-control @error('car_model') is-invalid @enderror">
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select class="form-control" name="car_type">
                                    ...
                                    <option value="2">{{ trans('Dashboard/ambulance.Leasing') }}</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-3">
                                ...
                                <input type="text" name="driver_name_en" value="{{ old('driver_name_en') }}"
                                    class="form-control @error('driver_name') is-invalid @enderror">
                            </div>

                            <div class="col-3">
                                <label>{{ trans('Dashboard/ambulance.driver_name_ar') }}</label>
                                <input type="text" name="driver_name_ar" value="{{ old('driver_name_ar') }}"
                                    class="form-control @error('driver_name') is-invalid @enderror">
                            </div>
