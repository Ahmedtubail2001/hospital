    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ trans('Dashboard/ambulance.Delete_ambulance_data') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Ambulance.destroy','test')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="h5 text-danger"> {{ trans('Dashboard/ambulance.Are_you_sure') }}</p>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-danger">{{trans('Dashboard/ambulance.delete')}}</button>
                    </div>
                </form>
            </div>
        </div>
