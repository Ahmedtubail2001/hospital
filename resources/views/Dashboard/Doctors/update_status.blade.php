        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">
                    {{ trans('Dashboard/doctor.Status_change') }}</h5>
            ...
            <form action="{{ route('update_status') }}" method="post" autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="status">{{trans('Dashboard/doctor.Status')}}</label>
                        <select class="form-control" id="status" name="status" required>
                            <option value="" selected disabled>-- {{trans('Dashboard/doctor.Choose')}} --</option>
