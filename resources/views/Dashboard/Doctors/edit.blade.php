    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('Dashboard/doctor.edit_doctors')}}</h5>
            ...
            <form action="{{ route('Doctors.update', 'test') }}" method="post">
                ...
                <div class="modal-body">
                    <label for="exampleInputPassword1">{{trans('Dashboard/doctor.name_doctors')}}</label>
